...
resource "aws_iam_role_policy_attachment" "lambda_books_executor_attach_trust_policy" {
  role       = "${aws_iam_role.lambda_books_executor.name}"
  policy_arn = "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"
}

resource "aws_iam_role_policy_attachment" "lambda_books_executor_attach_privilege_policy" {
  role       = "${aws_iam_role.lambda_books_executor.name}"
